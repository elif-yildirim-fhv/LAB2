...
public abstract class OrderServiceClient extends OrderServiceClientPowerApi implements OrderService, AkkaGrpcClient {
  ...
  protected final static class DefaultOrderServiceClient extends OrderServiceClient {
      ...
      private DefaultOrderServiceClient(GrpcChannel channel, boolean isChannelOwned, GrpcClientSettings settings, io.grpc.CallOptions options, Materializer mat, ExecutionContext ec, MetadataImpl defaultMetadata) {
        ...
        private final SingleResponseRequestBuilder<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest, at.fhv.sysarch.lab2.homeautomation.grpc.OrderResponse> processOrderRequestBuilder(akka.grpc.internal.InternalChannel channel){
          return new JavaUnaryRequestBuilder<>(processOrderDescriptor, channel, options, settings, defaultMetadata, ec);
        }
        ...
        /**
         * For access to method metadata use the parameterless version of processOrder
         */
        public java.util.concurrent.CompletionStage<at.fhv.sysarch.lab2.homeautomation.grpc.OrderResponse> processOrder(at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest request) {
          return processOrder().invoke(request);
        }

        /**
         * Lower level "lifted" version of the method, giving access to request metadata etc.
         * prefer processOrder(at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest) if possible.
         */
        
          
            public SingleResponseRequestBuilder<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest, at.fhv.sysarch.lab2.homeautomation.grpc.OrderResponse> processOrder()
          
        
        {
          return processOrderRequestBuilder(channel.internalChannel());
        }
      

      
        private static MethodDescriptor<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest, at.fhv.sysarch.lab2.homeautomation.grpc.OrderResponse> processOrderDescriptor =
          MethodDescriptor.<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest, at.fhv.sysarch.lab2.homeautomation.grpc.OrderResponse>newBuilder()
            .setType(
   MethodDescriptor.MethodType.UNARY 
            ...
            .setFullMethodName(MethodDescriptor.generateFullMethodName("orderservice.OrderService", "ProcessOrder"))
            .setRequestMarshaller(new ProtoMarshaller<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest>(OrderRequestSerializer))
            .setResponseMarshaller(new ProtoMarshaller<at.fhv.sysarch.lab2.homeautomation.grpc.OrderResponse>(OrderResponseSerializer))
